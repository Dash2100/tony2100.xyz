      ...
      <div className="flex justify-between items-center gap-8 p-8 px-12">
        <div className="flex gap-8">
          ...
          <div className="flex flex-col gap-1 text-[18px] my-auto">
            ...
            <h2 className="font-semibold text-[#4E5969]">
              本部落格所有文章除特別聲明外，均採用{' '}
              <span className="text-[#538AD9] cursor-pointer hover:underline">CC BY-NC-SA4.0</span>{' '}
              許可協議
            </h2>
        ...
        <div className="flex flex-col gap-5">
          <div className="w-full flex justify-between">
            <a
              href="#"
              className="bg-[#F3FAFF] p-2 shadow-inner rounded-xl w-fit h-fit justify-center items-start text-center border-[2px] border-[#4E5969]/20 cursor-pointer hover:bg-[#E8F6FF] ease-in-out duration-200"
            >
              <Image 
